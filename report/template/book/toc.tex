...
\ifnum \c@tocdepth >\m@ne
  ...
  \begingroup
    ...
    \leavevmode\colorbox{black}{\vtop{\hsize=\dimexpr\textwidth-2\fboxsep-4cm-7pt\relax% <- adjust the width
      \strut\color{orange}\bfseries\sffamily#1 % <- remove the initial space inside the box
      \nobreak\hfill\nobreak\hb@xt@\@pnumwidth{\hss #2}\strut}}\par
    \penalty\@highpenalty
  \endgroup
\fi}
